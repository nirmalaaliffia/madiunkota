    ...
    <header id="header" class="fixed-top header-transparent">
        ...
        <div class="container d-flex align-items-center justify-content-between">
          ...
          <li><a class="nav-link scrollto" href="#team">Team</a></li> -->
                    <li class="dropdown"><a href="#"  class="nav-link {{ ($parent === "berita") ? 'active':'' }}"><span>Berita</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                    ...
                    <li><a class="nav-link {{ ($parent === "agenda_kota") ? 'active':'' }}" href="/agenda_kota">Agenda Kota</a></li>
