      ...
      <div class="card-body">
          ...
          <div class="row">
                  ...
                  <div class="row">
                    {{-- @dd($list_kategori) --}}
                      ...
                      <div class="col-sm-5">
                          ...
                          <select class="form-control selectpicker" data-none-selected-text="Filter berdasarkan Kategori " style="width: 100%;" name="filter_kategori" multiple data-live-search="true">
              ...
              <div class="col-md-3 offset-md-1">
                  <button type="button" class="btn right-block btn-success " data-toggle="modal" data-target="#modal_tambah_berita"><i class="fa fa-plus"></i>&ensp; Tambah Berita Baru  </button>
              </div>
         ...
         <table id="tabel_berita" class="table table-striped" style="width:100%">
          <thead>
              <tr>
                  <th>No</th>
                  <th>Judul Berita</th>
          ...
          <tbody>
            ...
            @foreach ($berita as $berita)
              <tr>
                  ...
                  <td>{{  $berita->name }}</td>
                  <td><button type="button" class="btn btn-xs btn-warning" data-toggle="modal" data-target="#modal_edit_berita">
                    <i class="fas fa-edit"></i> 
                  </button>

                  <button type="button" class="btn btn-xs btn-info" data-toggle="modal" data-target="#modal_view_berita">
         ...
         <form class="form-horizontal">
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9" >
                ...
                <input type="file" name="foto_berita[]" multiple class="form-control" accept="image/*">
              </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9" >
              ...
              <input type="file" name="file_berita[]" multiple class="form-control" accept=".pdf">
            </div>
