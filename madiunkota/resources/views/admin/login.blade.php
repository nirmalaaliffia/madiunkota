...
<head>
  ...
  <title>Pemerintah Kota Madiun | Login Admin</title>
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <div class="m-t-17" style="text-align: center; width:100%">
            <img src="{{ asset('assets/img/Lambang_Kota_Madiun.png') }}" alt="" class="img-fluid " style="text-allign:center; width:30%; height:30%">
            <p class="login-box-msg">Masuk | Madiun Kota</p>
        </div>
